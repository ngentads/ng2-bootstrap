import { ApplicationRef, ComponentFactoryResolver, ComponentRef, Injector, ViewContainerRef, ResolvedReflectiveProvider } from '@angular/core';
...
export declare class ComponentsHelper {
     ...
     */
    appendNextToLocation<T>(ComponentClass: ConcreteType<T>, location: ViewContainerRef, providers?: ResolvedReflectiveProvider[]): ComponentRef<T>;
    /**
     ...
     * @returns {ComponentRef<T>} - returns ComponentRef<T>
     */
    appendNextToRoot<T>(ComponentClass: ConcreteType<T>, ComponentOptionsClass: any, options: any, contextInjector: Injector): ComponentRef<T>;
}
