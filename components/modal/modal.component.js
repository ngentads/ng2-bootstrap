...
var ModalDirective = (function () {
    ...
    ModalDirective.prototype.showBackdrop = function (callback) {
        ...
        if (this._isShown && this.config.backdrop) {
            this.backdrop = this.componentsHelper
                .appendNextToRoot(modal_backdrop_component_1.ModalBackdropComponent, modal_backdrop_component_1.ModalBackdropOptions, new modal_backdrop_component_1.ModalBackdropOptions({ animate: false }), this.injector);
            if (this.isAnimated) {
    ...
    ModalDirective = __decorate([
        ...
        __metadata('design:paramtypes', [core_1.ElementRef, core_1.Renderer, core_1.Injector, components_helper_service_1.ComponentsHelper])
    ], ModalDirective);
